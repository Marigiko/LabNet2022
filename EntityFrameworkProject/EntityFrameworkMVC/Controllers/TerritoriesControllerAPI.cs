...
{
    public class TerritoriesControllerAPI : ApiController
    {
        private NorthwindContext db = new NorthwindContext();

        // GET: api/TerritoriesControllerAPI
        public IQueryable<Territories> GetTerritories()
        {
            return db.Territories;
        }

        // GET: api/TerritoriesControllerAPI/5
        ...
        // PUT: api/TerritoriesControllerAPI/5
        ...
        // POST: api/TerritoriesControllerAPI
        [ResponseType(typeof(Territories))]
        ...
        // DELETE: api/TerritoriesControllerAPI/5
        [ResponseType(typeof(Territories))]
